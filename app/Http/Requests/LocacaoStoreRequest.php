...
class LocacaoStoreRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'data_final_realizado_periodo.required' => 'A data de entrega é obrigatória.',
            'data_final_realizado_periodo.date' => 'A data de entrega deve ser uma data válida.',
